...
// Marshal an object of type SimplePartitionScalerState to the protobuf v3 wire format
func (val *SimplePartitionScalerState) Marshal() ([]byte, error) {
	return proto.Marshal(val)
}

// Unmarshal an object of type SimplePartitionScalerState from the protobuf v3 wire format
func (val *SimplePartitionScalerState) Unmarshal(buf []byte) error {
	return proto.Unmarshal(buf, val)
}

// Size returns the size of the object, in bytes, once serialized
func (val *SimplePartitionScalerState) Size() int {
	return proto.Size(val)
}

// Equal returns whether two SimplePartitionScalerState values are equivalent by recursively
// comparing the message's fields.
// For more information see the documentation for
// https://pkg.go.dev/google.golang.org/protobuf/proto#Equal
func (this *SimplePartitionScalerState) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	var that1 *SimplePartitionScalerState
	switch t := that.(type) {
	case *SimplePartitionScalerState:
		that1 = t
	case SimplePartitionScalerState:
		that1 = &t
	default:
