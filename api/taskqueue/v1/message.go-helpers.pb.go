...
// Marshal an object of type LimiterRef to the protobuf v3 wire format
func (val *LimiterRef) Marshal() ([]byte, error) {
	return proto.Marshal(val)
}

// Unmarshal an object of type LimiterRef from the protobuf v3 wire format
func (val *LimiterRef) Unmarshal(buf []byte) error {
	return proto.Unmarshal(buf, val)
}

// Size returns the size of the object, in bytes, once serialized
func (val *LimiterRef) Size() int {
	return proto.Size(val)
}

// Equal returns whether two LimiterRef values are equivalent by recursively
// comparing the message's fields.
// For more information see the documentation for
// https://pkg.go.dev/google.golang.org/protobuf/proto#Equal
func (this *LimiterRef) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	var that1 *LimiterRef
	switch t := that.(type) {
	case *LimiterRef:
		that1 = t
	case LimiterRef:
...
// Marshal an object of type LimiterRelease to the protobuf v3 wire format
func (val *LimiterRelease) Marshal() ([]byte, error) {
	return proto.Marshal(val)
}

// Unmarshal an object of type LimiterRelease from the protobuf v3 wire format
func (val *LimiterRelease) Unmarshal(buf []byte) error {
	return proto.Unmarshal(buf, val)
}

// Size returns the size of the object, in bytes, once serialized
func (val *LimiterRelease) Size() int {
	return proto.Size(val)
}

// Equal returns whether two LimiterRelease values are equivalent by recursively
// comparing the message's fields.
// For more information see the documentation for
// https://pkg.go.dev/google.golang.org/protobuf/proto#Equal
func (this *LimiterRelease) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	var that1 *LimiterRelease
	switch t := that.(type) {
	case *LimiterRelease:
		that1 = t
	case LimiterRelease:
