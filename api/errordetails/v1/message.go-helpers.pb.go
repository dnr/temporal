...
// Marshal an object of type StalePartitionCountsFailure to the protobuf v3 wire format
func (val *StalePartitionCountsFailure) Marshal() ([]byte, error) {
	return proto.Marshal(val)
}

// Unmarshal an object of type StalePartitionCountsFailure from the protobuf v3 wire format
func (val *StalePartitionCountsFailure) Unmarshal(buf []byte) error {
	return proto.Unmarshal(buf, val)
}

// Size returns the size of the object, in bytes, once serialized
func (val *StalePartitionCountsFailure) Size() int {
	return proto.Size(val)
}

// Equal returns whether two StalePartitionCountsFailure values are equivalent by recursively
// comparing the message's fields.
// For more information see the documentation for
// https://pkg.go.dev/google.golang.org/protobuf/proto#Equal
func (this *StalePartitionCountsFailure) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	var that1 *StalePartitionCountsFailure
	switch t := that.(type) {
	case *StalePartitionCountsFailure:
		that1 = t
	case StalePartitionCountsFailure:
		that1 = &t
	default:
...
// Marshal an object of type FlowControlBlockedFailure to the protobuf v3 wire format
func (val *FlowControlBlockedFailure) Marshal() ([]byte, error) {
	return proto.Marshal(val)
}

// Unmarshal an object of type FlowControlBlockedFailure from the protobuf v3 wire format
func (val *FlowControlBlockedFailure) Unmarshal(buf []byte) error {
	return proto.Unmarshal(buf, val)
}

// Size returns the size of the object, in bytes, once serialized
func (val *FlowControlBlockedFailure) Size() int {
	return proto.Size(val)
}

// Equal returns whether two FlowControlBlockedFailure values are equivalent by recursively
// comparing the message's fields.
// For more information see the documentation for
// https://pkg.go.dev/google.golang.org/protobuf/proto#Equal
func (this *FlowControlBlockedFailure) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	var that1 *FlowControlBlockedFailure
	switch t := that.(type) {
	case *FlowControlBlockedFailure:
		that1 = t
	case FlowControlBlockedFailure:
		that1 = &t
	default:
