...
func (x *ConcurrencySlot) GetSlotId() string {
	if x != nil {
		return x.SlotId
	}
	return ""
...
func (x *ConcurrencyReserveRequest) GetSlotId() string {
	if x != nil {
		return x.SlotId
	}
	return ""
...
func (x *ConcurrencyCancelReservationRequest) GetSlotId() string {
	if x != nil {
		return x.SlotId
	}
	return ""
...
func (x *ConcurrencyCommitRequest) GetSlotId() string {
	if x != nil {
		return x.SlotId
	}
	return ""
...
func (x *ConcurrencyReleaseRequest) GetSlotId() string {
	if x != nil {
		return x.SlotId
	}
	return ""
...
const file_temporal_server_chasm_lib_flowcontrol_proto_v1_concurrency_proto_rawDesc = "" +
	...
	"generation\x12%\n" +
	"\x0eslots_reserved\x18\x02 \x01(\x05R\rslotsReserved\"s\n" +
	"#ConcurrencyCancelReservationRequest\x12!\n" +
	"\fnamespace_id\x18\x01 \x01(\tR\vnamespaceId\x12\x10\n" +
	"\x03key\x18\x02 \x01(\tR\x03key\x12\x17\n" +
	"\aslot_id\x18\x03 \x01(\tR\x06slotId\"&\n" +
	"$ConcurrencyCancelReservationResponse\"h\n" +
	"\x18ConcurrencyCommitRequest\x12!\n" +
	"\fnamespace_id\x18\x01 \x01(\tR\vnamespaceId\x12\x10\n" +
	"\x03key\x18\x02 \x01(\tR\x03key\x12\x17\n" +
	"\aslot_id\x18\x03 \x01(\tR\x06slotId\"\x1b\n" +
	"\x19ConcurrencyCommitResponse\"i\n" +
	"\x19ConcurrencyReleaseRequest\x12!\n" +
	"\fnamespace_id\x18\x01 \x01(\tR\vnamespaceId\x12\x10\n" +
	"\x03key\x18\x02 \x01(\tR\x03key\x12\x17\n" +
	"\aslot_id\x18\x03 \x01(\tR\x06slotId\"\x1c\n" +
...
var file_temporal_server_chasm_lib_flowcontrol_proto_v1_concurrency_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
