...
// Source: service/history/interfaces/chasm_tree.go
//
// Generated by this command:
//
//	mockgen -package interfaces -source service/history/interfaces/chasm_tree.go -destination service/history/interfaces/chasm_tree_mock.go
//
...
// ExecuteSideEffectStandbyTask mocks base method.
func (m *MockChasmTree) ExecuteSideEffectStandbyTask(ctx context.Context, executionKey chasm.ExecutionKey, task *tasks.ChasmTask, taskExists bool, validate func(chasm.NodeBackend, chasm.Context, chasm.Component) error) (bool, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ExecuteSideEffectStandbyTask", ctx, executionKey, task, taskExists, validate)
	ret0, _ := ret[0].(bool)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ExecuteSideEffectStandbyTask indicates an expected call of ExecuteSideEffectStandbyTask.
func (mr *MockChasmTreeMockRecorder) ExecuteSideEffectStandbyTask(ctx, executionKey, task, taskExists, validate any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ExecuteSideEffectStandbyTask", reflect.TypeOf((*MockChasmTree)(nil).ExecuteSideEffectStandbyTask), ctx, executionKey, task, taskExists, validate)
}
